...
| 资源 | `resource` | `resource` | 供给和需求方向资源的发布、审核、搜索、详情、刷新、成交、归档 |
...
| 运营后台 | `admin` | `admin` | 审核、配置、代发、资源管理、操作日志 |
...
5. 搭建 Vue 管理后台工程骨架。
6. 先跑通登录、城市站、资源列表、资源发布、资源详情和联系事件。
