...
export const defaultFlowChecks = [
  ...
  },
  {
    ...
    checks: ['getMerchant', 'listResources', 'ResourceCard', 'merchantResources', 'openResource', 'verificationStatus', 'resourcesSummary', 'merchantLogo', 'merchantImages', 'merchantLocation', 'openMerchantLocation', 'uni.openLocation', '地图导航', 'image-gallery', 'merchant-image', '权益提示', '联系前建议先从资源详情进入', 'getMerchantFollowState', 'setMerchantFollow', 'toggleFollow'],
  },
  {
