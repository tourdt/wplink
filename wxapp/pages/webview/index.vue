<template>
  <view class="webview-page">
    <view v-if="allowedUrl" class="activity-shell">
      ...
      <view class="activity-card">
        ...
        <view class="activity-body">
          ...
          <text class="activity-desc">活动页由已配置业务域名承载，返回小程序后可继续查看相关平台供应。</text>
          <button class="secondary-button" @click="openTopic">查看相关供应</button>
        </view>
      </view>
    ...
    <view v-else class="blocked-card">
      ...
      <button class="secondary-button" @click="openTopic">查看平台供应</button>
    </view>
  </view>
</template>
