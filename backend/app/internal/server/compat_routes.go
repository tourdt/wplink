...
func registerCompatAPIRoutes(srv *rest.Server, apiHandler http.Handler) {
	...
	srv.AddRoutes([]rest.Route{
		...
		{Method: http.MethodPut, Path: "/api/v1/resources/:resourceId/draft", Handler: handler},
		...
		{Method: http.MethodGet, Path: "/api/v1/me/resources/:resourceId/detail", Handler: handler},
		{Method: http.MethodGet, Path: "/api/v1/me/resources/:resourceId/edit", Handler: handler},
		...
		{Method: http.MethodDelete, Path: "/api/v1/resources/:resourceId", Handler: handler},
