...
func NewMerchantMapEventCleanupScheduler(runner MerchantMapEventCleanupRunner, interval time.Duration, logger *log.Logger) *MerchantMapEventCleanupScheduler {
	return &MerchantMapEventCleanupScheduler{runner: runner, interval: interval, logger: logger}
}
